...
<div class="container-fluid">
    ...
    <a class="navbar-brand pt-0" href="{{ route('home') }}">
        <img height="100px" width="90px" src="{{ asset('argon') }}/img/brand/blue.png" class="navbar-brand-img" alt="...">
    </a>
    <!-- User -->
    ...
    <div class="collapse navbar-collapse" id="sidenav-collapse-main">
        ...
        <form class="mt-4 mb-3 d-md-none">
            <div class="input-group input-group-rounded input-group-merge">
                <input type="search" class="form-control form-control-rounded form-control-prepended" placeholder="@lang('Search')" aria-label="Search">
    ...
    <form class="navbar-search navbar-search-dark form-inline mr-3 d-none d-md-flex ml-lg-auto">
        <div class="form-group mb-0">
            <div class="input-group input-group-alternative">
                ...
                <input class="form-control" placeholder="@lang('Search')" type="text">
            </div>
        </div>
    </form>
    <!-- User -->
